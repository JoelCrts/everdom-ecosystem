...
const Hero = () => {
  return /*#__PURE__*/React.createElement("section", {
    id: "home",
    className: "justify-between flex md:flex-row flex-col py-2"
  ...
  }, "Nosotros tambi\xE9n."))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
    className: "font-roboto font-light text-dimWhite text-[20px] leading-[30px] max-w-[550px] mt-5"
    ...
    className: `${styles.padding} items-center sm:flex-row`
  }, /*#__PURE__*/React.createElement("img", {
    src: everdomIcon,
    alt: "everdomIcon",
    className: "w-[382px] h-[382px] z-[5]"
  })));
};
export default Hero;